  ...
  return (
    <div className='flex-1 p-4 flex flex-col gap-4 xl:flex-row'>
        ...
        <div className="bg-lamaSky py-6 rounded-md flex-1 flex gap-4">
            ...
            <Image src="https://images.pexels.com/photos/20454417/pexels-photo-20454417/free-photo-of-skg-photography-professional-photography.jpeg" alt="" width={144} height={144} className="w-36 h-36 rounded-full object-cover"/>
            </div>
            <div className="w-2/3 flex flex-col justify-between gap-4">
                <h1 className="text-xl font-semibold">Bethel Solomon</h1>
